...
async function main() {
    ...
    console.log("Message : 1111111111111111111111111111", message)
    ...
    const completion2 = await groq.chat.completions.create({
        ...
        // Here tool add krne se again it call tool 
        // tools: [
        //     {
        //         type: "function",
        //         function: {
    ...
    console.log("message : 2222222222222222222222222222", message)
    console.log("completion2 :", JSON.stringify(completion2.choices[0].message, null, 2))
